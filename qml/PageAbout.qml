...
MyPage {
    ...
    ListModel {
        ...
        ListElement {
            ...
            labelUp: "Project's Name"
            labelDown: "myAirCoach"
        }
        ListElement {
            circleColor: "#ff9f00"
            circleSymbol: "W"
            ...
            labelUp: "Website"
            labelDown: "<a href='http://myaircoach.eu'>http://myaircoach.eu</a>"
        }
        ListElement {
            circleColor: "#00b300"
            circleSymbol: "P"
