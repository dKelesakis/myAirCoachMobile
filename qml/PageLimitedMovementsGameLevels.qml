...
MyPage {
    id: pageLevels
    title: qsTr("Limited movements")
    clip: true


    ListView {
        anchors.fill: parent
        model: limitedMovementsGameLevels
        ...
        Rectangle {
            ...
            Behavior on scale {
                SequentialAnimation {
                    ...
                    ScriptAction {
                        script: {
                            app.currentPage = "PageLimitedMovementsGame.qml"
                        }
                    }
                }
            }

            Component.onCompleted: rectButtonStart.scale = 1000//Math.sqrt( pageLevels.height*pageLevels.height + pageLevels.width*pageLevels.width )
        }
    }
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            if( rootWrapper.currentLevelIsLocked ) {
                                ...
                                gameSettings.currentLimit = limit
                            }
                        }
                        onPressedChanged: {
                            if( pressed ) {
